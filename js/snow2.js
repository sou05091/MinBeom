/*! Snowflakes | © 2021 Denis Seleznev | MIT License | https://github.com/hcodes/snowflakes/ */ ! function(a, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (a = a || self).Snowflakes = e()
}(this, function() {
    "use strict";
    ...
    function s(t, n) {
        Object.keys(n).forEach(function(a) {
            var e = a;
            i && -1 < a.search("animation") && (e = i + a[0].toUpperCase() + a.substr(1)), t.style[e] = n[a]
        })
    }
    ...
    function c(a, e, t, n, i) {
        return n + (i - n) * (a - e) / (t - e)
    }
    "undefined" != typeof window && (i = -1 < Array.prototype.slice.call(window.getComputedStyle(document.documentElement, "")).join(",").search(/,animation/) ? "" : "Webkit");
    var e, l, m, f = function() {
        function l(a) {
            o(this, l);
            var e = a.minSize === a.maxSize;
            this.innerSize = e ? 0 : h(0, l.maxInnerSize), this.size = l.calcSize(this.innerSize, a);
            var t = document.createElement("div"),
                n = document.createElement("div"),
                i = this.getAnimationProps(a),
                i = {
                    animationName: "snowflake_gid_".concat(a.gid, "_y"),
            ...
            e || (i.opacity = c(this.size, a.minSize, a.maxSize, a.minOpacity, a.maxOpacity)), s(t, i), s(n, {
                animationName: "snowflake_gid_".concat(a.gid, "_x_").concat(this.innerSize),
                animationDelay: 4 * Math.random() + "s"
            }), r(t, "snowflake"), r(n, "snowflake__inner"), a.types && r(n, "snowflake__inner_type_" + h(0, a.types)), a.wind && r(n, "snowflake__inner_wind"), a.rotation && r(n, "snowflake__inner_rotation" + (.5 < Math.random() ? "" : "_reverse")), t.appendChild(n), this._elem = t
        }
        return a(l, [{
            key: "getAnimationProps",
            value: function(a) {
                var e = a.containerHeight / 50 / a.speed,
                    t = e / 3;
                return {
                    animationDelay: Math.random() * e + "s",
                    animationDuration: c(this.size, a.minSize, a.maxSize, e, t) + "s"
                }
            }
        }, {
            key: "resize",
            value: function(a) {
                a = this.getAnimationProps(a);
                s(this._elem, a)
            }
        }, {
            key: "appendTo",
            value: function(a) {
                a.appendChild(this._elem)
            }
        }, {
            key: "destroy",
            value: function() {
            ...
            key: "calcSize",
            value: function(a, e) {
                return Math.floor(c(a, 0, l.maxInnerSize, e.minSize, e.maxSize))
            }
        }]), l
    }();
    m = 20, (l = "maxInnerSize") in (e = f) ? Object.defineProperty(e, l, {
        value: m,
        enumerable: !0,
        configurable: !0,
        writable: !0
    ...
    var _ = function() {
        function e(a) {
            o(this, e), this.params = this._setParams(a), this._isBody = this.params.container === document.body, this._setGid(), this._container = this._appendContainer(), this.params.stop && this.stop(), this._appendStyles(), this._appendFlakes(), this._handleResize = this._handleResize.bind(this), window.addEventListener("resize", this._handleResize, !1)
        }
        return a(e, [{
            key: "destroy",
            value: function() {
                this._removeStyles(), t(this._container), delete this._container, this._flakes.forEach(function(a) {
                    return a.destroy()
                }), delete this._flakes, delete this.params, window.removeEventListener("resize", this._handleResize, !1)
            }
        }, {
            key: "start",
            value: function() {
                var a, e;
                a = this._container, e = "snowflakes_paused", a.classList.remove(e)
            }
        }, {
            key: "stop",
            value: function() {
                r(this._container, "snowflakes_paused")
            }
        }, {
            key: "_setGid",
            value: function() {
                e._gid = e._gid || 0, e._gid++, this._gid = e._gid
            }
        }, {
            key: "_handleResize",
            value: function() {
                var e = this._getFlakeParams();
                s(this._container, {
                    display: "none"
                }), this._flakes.forEach(function(a) {
                    return a.resize(e)
                }), this._updateAnimationStyle(), s(this._container, {
                    display: "block"
                })
            }
        }, {
            ...
            value: function() {
                var e = this,
                    a = this._getFlakeParams();
                this._flakes = [];
                for (var t = 0; t < this.params.count; t++) this._flakes.push(new f(a));
                this._flakes.sort(function(a, e) {
                    return a.size - e.size
                }).forEach(function(a) {
                    a.appendTo(e._container)
                })
            }
        }, {
            key: "_setParams",
            value: function(t) {
                ...
                return [
                    ...
                    var e = a[0],
                        a = a[1];
                    n[e] = "boolean" == typeof a ? e in t ? t[e] : a : t[e] || a
                }), n
            }
        }, {
            key: "_getAnimationStyle",
            value: function() {
                for (var a = this._height() + this.params.maxSize * Math.sqrt(2) + "px", e = this._gid, t = "@-webkit-keyframes snowflake_gid_".concat(e, "_y{from{-webkit-transform:translateY(").concat("0px", ")}to{-webkit-transform:translateY(").concat(a, ");}}\n@keyframes snowflake_gid_").concat(e, "_y{from{transform:translateY(").concat("0px", ")}to{transform:translateY(").concat(a, ")}}"), n = 0; n <= f.maxInnerSize; n++) {
                    var i = f.calcSize(n, this.params) + "px";
                    t += "@-webkit-keyframes snowflake_gid_".concat(e, "_x_").concat(n, "{from{-webkit-transform:translateX(0px)}to{-webkit-transform:translateX(").concat(i, ");}}\n@keyframes snowflake_gid_").concat(e, "_x_").concat(n, "{from{transform:translateX(0px)}to{transform:translateX(").concat(i, ")}}")
                }
                return t
            }
        }, {
            ...
            key: "_removeStyles",
            value: function() {
                !--e._count < 1 && (t(this._mainStyleNode), delete this._mainStyleNode), t(this._imagesStyleNode), delete this._imagesStyleNode, t(this._animationStyleNode), delete this._animationStyleNode
            }
        }, {
            key: "_height",
            value: function() {
                return this.params.height || (this._isBody ? (e = document.body, t = document.documentElement, window.innerHeight ? a = window.innerHeight : t && t.clientHeight ? a = t.clientHeight : e && (a = e.clientHeight), a) : this.params.container.offsetHeight + this.params.maxSize);
                var a, e, t
            }
        }]), e
    }();
